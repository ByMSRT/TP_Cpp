rpg : main.o Character.o Mage.o Barbarian.o Priest.o Monster.o Exceptions.o Potion.o
	g++ main.o Character.o Mage.o Barbarian.o Priest.o Monster.o Exceptions.o Potion.o -o rpg --std=c++11
